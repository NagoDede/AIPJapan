 ...
 * @param {*} date 
 */
exports.setNextEffectiveDate = function (date) {
  global.nextEffectiveDate = date;
}
...
var _getAipDirectoryFromDoc = function (doc) {
  ...
  return path.join(global.AipJapanDirectory, yyyymmdd + '/');
}
 ...
 */
exports.getAirportPage =  function (name, url)
{
  return new Promise(function (resolve, reject) { resolve(_getAirportPage(name, url));});;
}
